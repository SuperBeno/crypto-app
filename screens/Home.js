            ...
            >
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{ marginLeft: SIZES.base }}>
                        ...
                        <Text style={{colors:COLORS.gray, ...FONTS.body3}}>{item.code}</Text>
                    </View>
                </View>
    ...
    function renderNotice() {
        return (
            ...
            >
                ...
                <Text style={{marginTop:SIZES.base, color:COLORS.white, ...FONTS.body4, lineHeight:18}}>It's very difficult to time an investment, especially when the market is volatile. Learn how to use dollar cost average to youre advantages.</Text>
                <TouchableOpacity
                    style={{
